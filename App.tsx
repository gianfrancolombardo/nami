            ...
            >
              ...
              <form onSubmit={handleLogFood} className="relative group">
                <textarea
                  ...
                  className="w-full p-5 pr-14 bg-black/20 border border-white/5 rounded-2xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500/50 outline-none resize-none text-base transition-all min-h-[120px] placeholder:text-slate-500 font-medium text-white"
                ...
                <motion.button
                  ...
                  className="absolute right-3 bottom-3 p-3 bg-indigo-500 text-white rounded-xl hover:bg-indigo-400 disabled:opacity-50 disabled:bg-slate-600 transition-all shadow-lg active:scale-90 z-10"
                >
                  {isProcessing ? (
